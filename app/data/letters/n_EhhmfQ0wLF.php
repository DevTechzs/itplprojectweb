...
// require_once 'api/generateELforCurrentMonth.php';
include 'api/generateELforCurrentMonth.php';
$LeaveCalculateEL = new  api\generateELforCurrentMonth\LeaveCalculateEL;

// $result = $LeaveCalculateEL->CalculateELByEndofMonth();
...
// LeaveCalculateEL::CalculateELByEndofMonth();
