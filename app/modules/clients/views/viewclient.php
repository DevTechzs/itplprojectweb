                        ...
                        <div class="card-header">
                            ...
                            <span class="float-right">
                                <button class="btn btn-success" data-toggle="modal" data-target="#modal-lg"> <i
                                        class="fa fa-circle-thin"> <i class="fa fa-plus"></i> </i>Add Client(s)</button>
                            </span>
                                    ...
                                    <div class="modal-content">
                                        <form method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="card-body text-center">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="client_name" class="form-control"
                                                                    maxlength="30" placeholder="Client Name"
                                                                    autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="telephone_number"
                                                                    ...
                                                                    maxlength="10" placeholder="Telephone Number"
                                                                    autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="fax" class="form-control"
                                                                    placeholder="Fax" maxlength="15" autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="person_designation">Person
                                                                    Designation</label>
                                                                <input type="text" id="person_designation"
                                                                    class="form-control" maxlength="20"
                                                                    placeholder="Person Designation" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="maxuser" class="form-control"
                                                                    placeholder="Max User" maxlength="3"
                                                                    autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer ">
                                                ...
                                                <button type="button" class="btn btn-primary" id="btnAddClient">Save
                                                </button>
                                            </div>
                                        </form>
                                    </div>
...
function loaddata(data) {
    ...
    if (data.length == 0) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            text += '   <a class="btn btn-danger btn-sm text-white" onclick="onDelete(' + data[i].ClientID +
...
$("#state").change(function() {
    ...
    for (let i = 0; i < Districts.length; i++) {
        if ($("#state option:selected").val() === Districts[i].StateID) {
            $("#district").append('<option value="' + Districts[i].DistrictID + '">' + Districts[i]
                .DistrictName + '</option>');
        }
    }
});
