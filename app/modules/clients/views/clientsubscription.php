                        ...
                        <div class="card-header">
                            ...
                            <span class="float-right">
                                <button class="btn btn-success" data-toggle="modal" data-target="#modal-lg"> <i
                                        class="fa fa-circle-thin"> <i class="fa fa-plus"></i>
                                    </i>Subscription(s)</button>
                            </span>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="unsubscribereason">Why do You want to
                                                                unsubscribe?</label>
                                                            <textarea name="" id="unsubscribereason"
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-primary" id="btnUnsubscribe">Save
                                            </button>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                                                    ...
                                                                    <div class="formbold-form-wrapper">
                                                                        <form method="POST" action="">
                                                                            <div class="formbold-steps">
                                                                                <ul>
                                                                                    <li
                                                                                        class="formbold-step-menu1 active">
                                                                                        <span>1</span>
                                                                                        Server
                                                                                    </li>
                                                                            ...
                                                                            <div class="formbold-form-step-2">
                                                                                <div class="card-body">
                                                                                    <p>Set Up Domain For First Time Use
                                                                                    </p>
                                                                                </div>
                                                                                <div>
                                                                                    <label for="address"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">ass="card-body text-center">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                <input type="text" name="" class="form-control" maxlength="6"
                                                    style="display:none" id="productamount">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="" class="form-control"
                                                            placeholder="Max User" maxlength="4" id="maxUser">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="" class="form-control"
                                                            Placeholder="Amount" maxlength="6" id="amount">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="" class="form-control"
                                                            Placeholder="InstallMent" id="installment">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="" class="form-control"
                                                            placeholder="Next Due date" id="nextDueDate">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="" class="form-control"
                                                            placeholder="Next Due Amount" id="nextDueAmount">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" id="terms" class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="api" class="form-control"
                                                            placeholder="https://test.com/index.php" autocomplete="off">
                                                    </div>
                                                </div>
...
function loaddata(data) {
    ...
    if (data.length == 0) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            text += '    <a class="btn btn-info btn-sm text-white" onclick="onUnsubscribe(\'' + escape(JSON.stringify(
                data[i])) + '\')"> Unsubscribe </a>';
            text += '   <a class="btn btn-info btn-sm text-white" onclick="onEdit(\'' + escape(JSON.stringify(data[
                i])) + '\')"> <i class="fas fa-pencil-alt"> </i> </a>';
            text += '   <a class="btn btn-danger btn-sm text-white" onclick="onDelete(' + data[i].ClientSubscriptionID +
                ')"> <i class="fas fa-trash"> </i> </a>';
            text += '   <a class="btn btn-success btn-sm text-white" onclick="createDomain(' + data[i].ProductID +
                ')">Create Domain </a>';
            text += '</td>';
            text += '</tr >';
        }
...
$("#productID").change(function() {
    ...
    for (let i = 0; i < ProductSubscription.length; i++) {
        if ($("#productID option:selected").val() === ProductSubscription[i].ProductID) {
            $("#subscriptionId").append('<option value="' + ProductSubscription[i].ProductSubscriptionID +
                '">' + ProductSubscription[i].SubscriptionName + '</option>');
        }
    }
});
</script>
