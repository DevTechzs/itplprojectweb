<div class="second-child-1 p-2">
    ...
    <div class="modal fade " id="showTeamMemberModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="team-members-modal-content modals-content" style="width:600px">
                    ...
                    <button id="addNewMemberbtn" type="button" class="btn btn-primary"
                        onclick="addNewTeamMember(`${localStorage.getItem('itplappprojectid')}`)">Add</button>
    ...
    <div class="modal fade " id="editTeamMember" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md">
                            ...
                            <label id="remove-module-remarks-label-id" for="member-remove-remarks"
                                style="display:none;">Remove Remarks</label>
                            <textarea id="member-remove-remarks-text" name="member-remove-remarks" style="display:none;"
                                cols="50"></textarea>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="removeTeamMember" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-danger" id="confirmRemoveTeamMember"
                        onclick="removeTeamMember()">CONFIRM</button>
                </div>
            </div>
        </div>
    </div>
