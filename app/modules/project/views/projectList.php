                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="row mb-3">
                                            ...
                                            <input type="text" id="project-title" class="form-control" placeholder="Enter project title" onchange="validateField('#project-title', 'Project Title should be at least 6 characters')">
                                        </div>
                                        <div class="row mb-3">
                                            <label for="project-description">
                                                Description <span style="color:red">*</span></label>

                                            <textarea id="project-description" class="form-control" placeholder="Enter project description" onchange="validateField('#project-description','Project Description should be atleast 6 chars')"></textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <select type="text" id="client-id" class="form-control" placeholder="Enter Client ID"></select>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="text" id="workorder-number" name="workorder-number" class="form-control" placeholder="Enter Workorder Number">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="date" id="workorder-date" name="workorder-date" class="form-control">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="file" id="workorder-filename" name="workorder-filename" class="form-control" placeholder="Enter Workorder Filename">
                                    ...
                                    <div class="col-sm ml-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <select id="project-coordinator" name="project-coordinator" class="form-control"></select>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="text" id="client-coordinator-name" name="client-coordinator-name" class="form-control" placeholder="Enter Client Coordinator Name">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="tel" id="client-coordinator-contact-no" class="form-control" placeholder="Enter Contact Number">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="number" id="project-budget" name="project-budget" class="form-control" placeholder="Enter Project Budget">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="date" id="project-due-date" name="project-due-date" class="form-control">
                                ...
                                <div class="pt-4">
                                    <div class="row justify-content-end">
                                        <div class="col-sm-9">
                                            <button type="submit" class="btn btn-primary me-sm-2 me-1" id="addBtn">Create Project</button>
                                        </div>
                                    </div>
                                </div>
