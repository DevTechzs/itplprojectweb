        ...
        <div id="addTask" class="team-members-modal ">
            <div class="modals-content" id="addTaskModal" style="overflow-y:scroll;">
                <div class="card mb-4 p-2">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label required">Assigned
                            To</label>
                        <div class="col-sm-9">
            ...
            <div class="modal-content" style="width:600px;">
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary task-btn-save" data-field="newTaskTitle">Save</button>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary task-btn-save" data-field="newTaskDescription">Save</button>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <select name="staff-select" id="newAssignedToStaffIDs" class="form-control" onchange=""></select>
                        </div>
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary task-btn-save" data-field="newAssignedToStaffIDs">Save</button>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary task-btn-save" data-field="newTaskStatus">Save</button>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary task-btn-save" data-field="newPriority">Save</button>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary task-btn-save" data-field="newDueDate">Save</button>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary task-btn-save" data-field="staffsToRemoveFromTask">Remove</button>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary" id=newTaskDocumentBtn data-field="newTaskDocument">Upload</button>
                        </div>
                    </div>
                </div>
...
<script>
    $('#ProjectModuleSelect').on('change', function() {
        const moduleID = $(this).val();
        $("#slTeamMembers").html('')
        const obj = {
            Module: "Project",
            Page_key: "moduleMembersForTask"
        }
        const json = {
            ModuleID: moduleID
        }
        ...
        if (rc.return_code) {
            switch (rc.Page_key) {
                ...
                case "moduleMembersForTask":
                    loadTask("#newAssignedToStaffIDs", rc.return_data);
    ...
    function openEditModal(taskID, taskTitle, taskDescription, assignedToStaffNames, dueDate, projectModuleID,
        ...
        // $("#newAssignedToStaffIDs").val(assignedToStaffNames);
        ...
        //     const obj = {
        //         Module: "Project",
        //         Page_key: "memberNotInModuleTask"
        //     }
        //     const json = {
