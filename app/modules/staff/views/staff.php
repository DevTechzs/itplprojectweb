                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-primary" id="btnAddStaff">Save
                                            </button>
                                        </div>
                                    </div>
                                </div>
    ...
    if (data.length == 0) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            text += '   <a class="btn btn-info btn-sm text-white" onclick="onEdit(\'' + escape(JSON.stringify(data[
                i])) + '\')"> <i class="fas fa-pen"> </i> </a>';
            text += '   <a class="btn btn-info btn-sm text-white" onclick="openProfile(\'' + data[i].StaffID +
                '\')"> <i class="fas fa-address-card"> </i> </a>';
            text += '   <a class="btn btn-info btn-sm text-white" onclick="staffAttendanceDetail(' + data[i].StaffID +
                ',\'' + data[i].StaffName + '\')"> <i class="fas fa-clock"> </i> </a>';
